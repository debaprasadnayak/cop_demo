...
Usage: python cop_demo/scripts/ingest_bronze.py
"""
...
PROFILE       = "YOUR_PROFILE"        # Replace with your Databricks CLI profile name
WAREHOUSE_ID  = "YOUR_WAREHOUSE_ID"   # Replace with your SQL warehouse ID
...
def main():
    ...
    if PROFILE == "YOUR_PROFILE" or WAREHOUSE_ID == "YOUR_WAREHOUSE_ID":
        print("❌ Error: Please configure PROFILE and WAREHOUSE_ID in this script.")
        print("   Edit lines 14-15 with your Databricks workspace credentials.")
        return 1
